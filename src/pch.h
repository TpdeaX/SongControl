...
struct VariableA {
	...
	bool m_bShowPositionMusic = false;
	bool m_bAutoPlayNextSong = false;
	bool m_bAutoPlayOnSongChange = false;
	bool m_bLiveSearch = false;
	bool m_bLiveSearchUsingArtisName = 0;
	int m_iKeyShowReproductor = 0x10;
